        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisibilityLevel = table.Column<uint>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxIndex = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    CalendarEventId = table.Column<Guid>(nullable: false),
                    GuestId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CalendarGuests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CalendarGuests_CalendarEvents_CalendarEventId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    MessageThreadId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageThreadUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MessageThreadUsers_MessageThreads_MessageThreadId",
                        column: x => x.MessageThreadId,
                        principalTable: "MessageThreads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CalendarGuests_CalendarEventId",
                table: "CalendarGuests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageThreadUsers_MessageThreadId",
                table: "MessageThreadUsers",
                column: "MessageThreadId");
        }
